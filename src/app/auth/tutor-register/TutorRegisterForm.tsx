  ...
  return (
    <div className={`animate-fade-in ${styles.authContainer}`}>
      <div className={styles.authCard}>
        <h2 className={styles.authTitle}>Tutor Registration</h2>
        ...
        <form action={handleSubmit}>
          ...
          <div className={styles.formGroup}>
            ...
            <input name="cgpa" type="number" step="0.01" min="0" max="4.0" required className={styles.input} placeholder="e.g. 3.50" />
          </div>
        ...
        <div className={styles.authLinks}>
          Already have an account? <Link href="/auth/tutor-signin">Sign In</Link>
        </div>
      </div>
    </div>
  );
