~~1 Users > edit > remove role dropdown~~ ✅ (removed from ProfileForm)
~~2 Admin can directly increase / reduce the wallet balance, the user will be notified and the reason will also be saved in transaction history.~~ ✅ (already shipped at /admin/wallets — adjustUserBalance writes WalletTransaction + Notification + email)
~~3 Admin > make a new section name "consultancy" p-1~~ ✅ (new /admin/consultancy page with Requests + Topics tabs)
